...
void car_simulator::Prepare(void)
{
    ...
    /* ROS topics */
    vehicleCommand_subscriber = Handle.subscribe("/car_input", 1, &car_simulator::vehicleCommand_MessageCallback, this);
...
void car_simulator::RunPeriodically(void)
{
...
void car_simulator::Shutdown(void)
{
    // Delete ode object
    delete simulator;
...
void car_simulator::vehicleCommand_MessageCallback(const std_msgs::Float64MultiArray::ConstPtr& msg)
{
...
void car_simulator::PeriodicTask(void)
{
    /*  Integrate the model */
    simulator->integrate();
